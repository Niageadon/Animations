...
const routes = [
    { path: '/CSS/card-flip', component: () => import('pages/CSSAnimation/Flip/CardFlip/index.vue') },
    { path: '/CSS/cube-flip', component: () => import('pages/CSSAnimation/Flip/CubeFlip/index.vue') },
